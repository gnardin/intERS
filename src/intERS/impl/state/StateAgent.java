...
public class StateAgent extends StateAbstract {
  ...
  public StateAgent( ScenarioConf scenarioConf, Context<Object> context, Map<Integer, ExtorterAbstract> extorters, Map<Integer, TargetAbstract> targets, Integer id, Double prisonProbability, Integer prisonRounds ) {
