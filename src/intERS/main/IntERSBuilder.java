...
public class IntERSBuilder extends DefaultContext<Object> implements
	...
	public Context<Object> build(Context<Object> context) {
		...
		String scenarioFilename = (String) params.getValue(PARAM_SCENARIO_FILENAME);
		String schemaFilename = (String) params.getValue(PARAM_SCHEMA_FILENAME);
		
		OutputConf outputConf = new OutputConf();
		outputConf.setDirectory(((String) params.getValue(PARAM_OUTPUT_DIRECTORY))
		...
		context.addContextListener(new ContextUpdate(this.extorters, this.targets));
		...
		for(ExtorterConf extorterConf : extortersScenario) {
			...
			strategyConf.upload((String) params.getValue(PARAM_OUTPUT_DIRECTORY),
					(String) params.getValue(PARAM_OUTPUT_FIELD_SEPARATOR), extorterConf);
		...
		/**
		 * DEFINE THAT ALL TARGETS ARE EXTORTED BY MORE THAN ONE EXTORTER AND
		 * ALL EXTORTERS HAVE THE SAME NUMBER OF TARGETS ASSIGNED TO THEM
		 */
		int targetId;
