...
public abstract class ExtorterAbstract {
	...
	public ExtorterAbstract(Map<Integer, ExtorterAbstract> extorters,
		...
		this.impulseFightProtectionProb = extorterConf.getImpulseFightProtection() / 100;
		...
		this.extortion = extorterConf.getExtortersStrategy().getExtortion(this.id);
	...
	public void updateWealthProtection() {
		...
		this.output.setTotalLostFightProtection(this.output
				.getTotalLostFightProtection() + this.lossWealthProtection);
	}
	...
	public void counterattackRetaliation() {
		...
		// Output
		this.output.setNumCounterattackRetaliation(this.counterattackRetaliation
				.size());
	}
	...
	public void updateWealthRetaliation() {
		...
		this.output.setTotalLostFightRetaliation(this.output
				.getTotalLostFightRetaliation() + this.lossWealthRetaliation);
	}
